...
def main( numEvents , numFiles , outDir , energyMin , energyMax , thetaMin , thetaMax , hcalDepth, timeWindow, timeShift, detector ) :
    ...
    for n in range(numFiles):
        ...
        while i < numEvents:
            ...
            #This part has been changed since the old version didn't assign vertecies to muons that only intersected the sides in the z-plane.
            intersected = False
